...
type Appointment = z.infer<typeof formSchema>

export default function NewAppointmentForm({ data=null, mode }: { data: Appointment | null, mode: 'read-only' | 'edit' | 'new' }) {
